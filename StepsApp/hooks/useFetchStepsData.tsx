...
const useHealthData = (date: Date) => {
  ...
  const readSampleData = async () => {
    ...
    const totalSteps = Array.isArray(steps)
      ? steps.reduce((sum, cur) => sum + (cur.count || 0), 0)
      : 0;
    ...
    const totalDistance = Array.isArray(distance)
      ? distance.reduce((sum, cur) => sum + (cur.distance?.inMeters || 0), 0)
      : 0;
    ...
    const totalFloors = Array.isArray(floorsClimbed)
      ? floorsClimbed.reduce((sum, cur) => sum + (cur.floors || 0), 0)
      : 0;
